            ...
            <div className="sectionText">
                ...
                <div className="hero-content">
                    ...
                    <h2 data-aos='fade-up' className="hero-subtitle">
                        Your Gateway to <span className="highlight">Sustainable Adventures</span>
                    </h2>
                    ...
                    <form className='hero-search-bar' onSubmit={handleSearch} data-aos='fade-up' data-aos-delay='200'>
                    ...
                    {process.env.NODE_ENV === 'development' && (
                        <div className='dev-badge'>
                            {useVideo ? '🎥 Video Mode' : '🖼️ Image Mode'} | Speed: {connectionSpeed?.toUpperCase()}
                        </div>
                    )}
                </div>
