...
const Home = () => {
    ...
    const handleSearch = (e) => {
        ...
        if (searchQuery.trim()) {
            ...
            window.location.href = `/destinations?location=${encodeURIComponent(searchQuery)}`;
        }
    };
            ...
            <div className="sectionText">
                ...
                <div className="mission-box" data-aos='fade-up' data-aos-delay='100'>
                    <p className="mission-text">
                        Experience the <strong>soul of Incredible India</strong> through sustainable travel. 
                        From the snow-capped Himalayas to the backwaters of Kerala, 
                        every journey tells a story. <span className="highlight">What's yours?</span>
                    </p>
                </div>

                {/* Search Experience */}
                <div className="search-experience" data-aos='fade-up' data-aos-delay='200'>
                    ...
                    <div className='popular-tags'>
                        <button onClick={() => setSearchQuery('Himalayas')} className='tag'>🏔️ Himalayas</button>
                        <button onClick={() => setSearchQuery('Kerala')} className='tag'>🌴 Kerala Backwaters</button>
                        <button onClick={() => setSearchQuery('Rajasthan')} className='tag'>🏰 Rajasthan Forts</button>
                        <button onClick={() => setSearchQuery('Goa')} className='tag'>🏖️ Goa Beaches</button>
                    </div>
                </div>
                ...
                {/* Popular Activities */}
                <div className="activities-section" data-aos='fade-up' data-aos-delay='450'>
                    <h2 className="section-heading">Adventure Awaits</h2>
                    <div className="activities-grid">
                        <Link to="/destinations?activity=Trekking" className="activity-card">
                            <div className="activity-icon">🥾</div>
                            <h3>Trekking</h3>
                            <p>50+ Trails</p>
                        </Link>
                        <Link to="/destinations?activity=River Rafting" className="activity-card">
                            <div className="activity-icon">🚣</div>
                            <h3>River Rafting</h3>
                            <p>15+ Rapids</p>
                        </Link>
                        <Link to="/destinations?activity=Wildlife Safari" className="activity-card">
                            <div className="activity-icon">🦁</div>
                        ...
                        <Link to="/destinations?activity=Paragliding" className="activity-card">
                            <div className="activity-icon">🪂</div>
                            <h3>Paragliding</h3>
                            <p>10+ Spots</p>
                        </Link>
                        <Link to="/destinations?activity=Scuba Diving" className="activity-card">
                            <div className="activity-icon">🤿</div>
                            <h3>Scuba Diving</h3>
                            <p>8+ Islands</p>
                        </Link>
                ...
                {/* Featured Collection */}
                <div className="featured-collection" data-aos='fade-up' data-aos-delay='500'>
                    ...
                    <div className="destinations-grid">
                        ...
                        <Link to="/destinations?location=Uttarakhand" className="destination-card">
                            <div className="card-image">
                        ...
                        <Link to="/destinations?location=Kashmir" className="destination-card">
                            <div className="card-image">
