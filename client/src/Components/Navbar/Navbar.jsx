        ...
        <div className="navBarWrapper">
            <div className="navBar">
                ...
                <div className="navBarLogo">
                    <Link to="/">
                        <img src={logo} className="logoimg" alt="SafarNama Logo" />
                ...
                <div className="navBarDesktop">
                    <ul className="navLinks">
                        ...
                        {/* <li><ProtectedLink to="/homegram">SafarGram</ProtectedLink></li> */}
                        <li><ProtectedLink to="/blogs">Blog</ProtectedLink></li>
                    ...
                    <div className="navActions">
                        {/* <button className="iconBtn" onClick={() => navigate('/chat')}>
                            <RiRobot2Fill className="icon robot" />
                        </button> */}
                        {!isAuthenticated && (
                ...
                <div className={`mobileMenu ${isMobileMenuOpen ? 'show' : ''}`}>
                    <div className="mobileMenuContent">
                        ...
                        <nav className="mobileNav">
                            ...
                            <ProtectedLink to="/homegram" onClick={() => toggleMobileMenu(false)}>
                                <RiCameraLine className="icon" />
                                SafarGram
                            </ProtectedLink>
                            <ProtectedLink to="/blogs" onClick={() => toggleMobileMenu(false)}>
                        ...
                        <div className="mobileActions">
                            ...
                            {isAuthenticated ? (
                                ...
                                <Link to="/auth" className="signUpBtn" onClick={() => toggleMobileMenu(false)}>
